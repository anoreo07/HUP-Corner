...
/**
 * Convert Word (.docx) to HTML for inline preview.
 * Returns a full HTML page with styling.
 */
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    h1 { font-size: 1.75em; margin: 1em 0 0.5em; color: #111827; }
    h2 { font-size: 1.4em; margin: 1em 0 0.4em; color: #1f2937; }
